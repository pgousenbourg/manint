function pb = curve_reconstruction_mean_all_c1(varargin)
% Reconstructs the Bezier curve based on a karcher mean.
%
% function pb = curve_reconstruction_mean_all_c1(pb,X,Y)
...
%    piecewise cubic and ensured to be C^1.
%
...
% see <http://www.gnu.org/licenses/>.
  ...
  curve = zeros(mX,nX,r,c);
	...
	% Computation of fictionnal control points here
	...
	for l = 1:nX
		...
		% Solution
    y = decasteljau2d_mean_c1(M,cp,t1,t2,patchX+1,patchY+1,m-1,n-1);
		curve(k,l,:,:) = y;

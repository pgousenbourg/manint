function pb = curve_reconstruction_decasteljau_exp(varargin)
% Reconstructs the Bezier curve based on non-continuous 2d-deCasteljau
% approach.
% DISCLAIMER: THIS PROGRAM IS ONLY FOR PEDAGOGIGAL PURPOSES.
%
% function pb = curve_reconstruction_decasteljau_exp(pb,X,Y)
...
%    piecewise cubic and of type III.
%
...
% Change log:
% 	Feb. 21, 2019 (PYG) - Integration of the Manopt framework.
...
% see <http://www.gnu.org/licenses/>.
  ...
  % For each value of (X,Y)
    ...
    % Curve reconstruction -- Specific for this method
		y = decasteljau2d_exp(M,cp,t1,t2);
		curve(k,l,:,:) = y;
    % end specific
